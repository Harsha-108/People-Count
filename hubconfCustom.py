...
email_sender = 'harsh2021cs068@abesit.edu.in'
email_recipient = 'harshchoudharym101@gmail.com'
...
def violation_alert_generator(im0, subject= 'People Count Exceeded', message_text='More than 4 Persons detected !!'):
    """
        ...
        try:
            ...
            while True:
                ...
                for i, det in enumerate(pred):
                    ...
                    text_color = (48, 25, 52) 
                    text_thickness = 2
                    cv2.putText(img0, f"Total Persons: {total_detections}", text_position, font, 2, text_color, text_thickness, cv2.LINE_AA)
